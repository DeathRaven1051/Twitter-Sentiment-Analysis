...
consumer_key = "IUOzImbzcVRiPVPu41g838xeB"
consumer_secret = "7deHkXVw9cXmoRzTPVIOUoBDh03ap4ZS6lg0svgSKHN4LEr39G"
access_token = "1316587332909162496-hTFKl7oN0iANdLF4leHoKJwZacDPll"
access_token_secret = "rJT2CEd2d5YgwCMZqpGLZHtfduShWlY8NNW0Hxv8OD4lV"
...
api = tw.API(auth, wait_on_rate_limit=True) # use smaller batches during api calls  
...
tweets = tw.Cursor(api.search_tweets, q="%s" %keyword, lang="en",since=start_date, tweet_mode='extended').items(ntweets) #from:user #-filter:retweets
